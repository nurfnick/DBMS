...
<title>Query Result</title>
    ...
    /*
     * If the user hasn't filled out all the info. This is very simple checking.
     */
    if (startTime.equals("") || movieName.equals("") || durationString.equals("")) {
        response.sendRedirect("add_customer_form.jsp");
    } else {
        int duration = Integer.parseInt(durationString);//change category to an int
        
        // Now perform the query with the data from the form.
        boolean success = handler.addCustomer(startTime, movieName, duration);//add the customer
        if (!success) { // Something went wrong
            ...
            <a href="get_all_customers_form.jsp">See all customers.</a>//link back to table
            <%
        }
    }
    %>
